...
const Info = () => {
  return (
    <div className="grid pb-40">
      ...
      <h1 className=" mt-10 flex justify-center text-3xl font-medium">Trabajo Práctico Integrador</h1>
    <div className="flex justify-center  ">
      
      <div className="max-w-[1200px] bg-gray-950 p-10 mt-10 rounded-lg"><h2 className="text-lg ml-10">1- Lo que debe contemplar el proyecto integrador</h2>
      <ul className="grid grid-cols-1 gap-2 mx-20 mt-2">
        <div></div>
      ...
      <h2 className="text-lg ml-10 mt-4">2- Validación</h2>
      <ul className="grid grid-cols-1 gap-2 mx-20 mt-2">
